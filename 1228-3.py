...
w2 = init_weights([20, 20, 32, 64])     # 3x3x32 conv, 64 outputs
w3 = init_weights([20, 20, 64, 128])    # 3x3x32 conv, 128 outputs
w4 = init_weights([20, 20, 128, 128])    # 3x3x32 conv, 128 outputs
w5 = init_weights([20, 20, 128, 128])    # 3x3x32 conv, 128 outputs
