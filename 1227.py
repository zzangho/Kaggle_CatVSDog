...
def model(X, w1, w2, w3, w4, w5, w_o, p_keep_conv, p_keep_hidden):
    ...
    l4a = tf.nn.relu(tf.nn.conv2d(l3, w4,  # l3a shape=(?, 7, 7, 128)
                                  strides=[1, 1, 1, 1], padding='SAME'))
    l4 = tf.nn.max_pool(l3a, ksize=[1, 2, 2, 1],  # l3 shape=(?, 4, 4, 128)
                        strides=[1, 2, 2, 1], padding='SAME')
...
with tf.Session() as sess:
    ...
    py_x = model(X, w1, w2, w3, w4, w5, wo, p_keep_conv, p_keep_hidden)
